...
export const Route = createFileRoute("/services/attention")({
  head: () => ({
    meta: [
      { title: `${p.label} — Flogrit` },
      { name: "description", content: `${p.oneLine} Content strategy, video, brand and creative direction — designed to compound.` },
      { property: "og:title", content: `${p.label} — Flogrit` },
      { property: "og:description", content: `${p.oneLine} The first pillar of the Flogrit growth system.` },
    ],
  }),
      ...
      <section className="border-b border-border bg-background">
        <div className="mx-auto max-w-7xl px-5 py-24 lg:px-8 lg:py-32">
          ...
          <h1 className="mt-4 max-w-4xl font-display text-5xl font-semibold leading-[1.02] tracking-[-0.02em] md:text-6xl lg:text-7xl">
            {p.oneLine.replace(/\.$/, "")} — <span className="text-primary">on purpose, not by accident.</span>
          </h1>
